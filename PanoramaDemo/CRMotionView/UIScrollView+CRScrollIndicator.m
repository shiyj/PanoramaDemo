...
- (void)cr_enableScrollIndicator
{
    ...
    if (nil == backgroundViewScrollIndicator) {
        backgroundViewScrollIndicator = [[UIView alloc] initWithFrame:backgroundIndicatorFrame];
    ...
    backgroundViewScrollIndicator.frame = backgroundIndicatorFrame;
    ...
    if (nil == viewScrollIndicator) {
        viewScrollIndicator = [[UIView alloc] initWithFrame:frame];
    ...
    viewScrollIndicator.frame = frame;
